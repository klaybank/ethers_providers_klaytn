...
function getTransactionPostData(transaction) {
    ...
    for (var key in transaction) {
        ...
        if ({ type: true, gasLimit: true, gasPrice: true, nonce: true, value: true }[key]) {
            ...
            var sets = (0, transactions_1.accessListify)(value);
...
var EtherscanProvider = /** @class */ (function (_super) {
    ...
    function EtherscanProvider(network, apiKey) {
        ...
        (0, properties_1.defineReadOnly)(_this, "baseUrl", baseUrl);
    ...
    EtherscanProvider.prototype.getHistory = function (addressOrName, startBlock, endBlock) {
        ...
        return this.resolveName(addressOrName).then(function (address) {
            ...
            return (0, web_1.fetchJson)(connection, null, getResult).then(function (result) {
                _this.emit("debug", {
                    action: "response",
                    request: url,
                    response: (0, properties_1.deepCopy)(result),
